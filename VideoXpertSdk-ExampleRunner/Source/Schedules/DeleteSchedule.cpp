...
Plugin* ExampleRunner::Schedules::DeleteSchedule::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxSchedule**> ExampleRunner::Schedules::DeleteSchedule::GetSchedules(IVxSystem* vxSystem) {
...
void ExampleRunner::Schedules::DeleteSchedule::PrintSchedules(VxCollection<IVxSchedule**> scheduleCollection) {
...
int ExampleRunner::Schedules::DeleteSchedule::SelectScheduleIndex(VxCollection<IVxSchedule**> &schedules) {
    while (true) {
