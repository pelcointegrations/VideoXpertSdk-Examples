...
Plugin* ExampleRunner::Schedules::ViewAllSchedules::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxSchedule**> ExampleRunner::Schedules::ViewAllSchedules::GetSchedules(IVxSystem* vxSystem) {
...
void ExampleRunner::Schedules::ViewAllSchedules::PrintSchedules(VxCollection<IVxSchedule**> scheduleCollection) {
