...
Plugin* ExampleRunner::Situations::DisplaySituations::Run(DataModel* dataModel) {
...
void ExampleRunner::Situations::DisplaySituations::Display(IVxSystem* vxSystem) {
...
VxCollection<IVxSituation**> ExampleRunner::Situations::DisplaySituations::GetSituations(IVxSystem* vxSystem) {
...
void ExampleRunner::Situations::DisplaySituations::DisplaySituationDetailsOnScreen(VxCollection<IVxSituation**> situations) {
