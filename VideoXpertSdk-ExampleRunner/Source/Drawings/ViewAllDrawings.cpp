...
Plugin* ExampleRunner::Drawings::ViewAllDrawings::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxDrawing**> ExampleRunner::Drawings::ViewAllDrawings::GetDrawings(IVxSystem* vxSystem) {
...
void ExampleRunner::Drawings::ViewAllDrawings::PrintDrawings(VxCollection<IVxDrawing**> drawingCollection) {
