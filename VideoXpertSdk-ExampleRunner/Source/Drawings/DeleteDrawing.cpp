...
Plugin* ExampleRunner::Drawings::DeleteDrawing::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxDrawing**> ExampleRunner::Drawings::DeleteDrawing::GetDrawings(IVxSystem* vxSystem) {
...
void ExampleRunner::Drawings::DeleteDrawing::PrintDrawings(VxCollection<IVxDrawing**> drawingCollection) {
...
int ExampleRunner::Drawings::DeleteDrawing::SelectDrawingIndex(VxCollection<IVxDrawing**> &drawings) {
    while (true) {
