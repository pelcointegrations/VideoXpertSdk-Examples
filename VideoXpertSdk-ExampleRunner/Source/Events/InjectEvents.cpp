...
Plugin* ExampleRunner::Events::InjectEvents::Run(DataModel* dataModel) {
...
void ExampleRunner::Events::InjectEvents::Inject(IVxSystem* vxSystem) {
...
VxCollection<IVxSituation**> ExampleRunner::Events::InjectEvents::GetSituations(IVxSystem* vxSystem) {
...
void ExampleRunner::Events::InjectEvents::DisplaySituationDetailsOnScreen(VxCollection<IVxSituation**> situations) {
