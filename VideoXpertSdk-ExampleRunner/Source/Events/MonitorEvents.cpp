...
Plugin* ExampleRunner::Events::MonitorEvents::Run(DataModel* dataModel) {
...
void ExampleRunner::Events::MonitorEvents::StartMonitorEvents(IVxSystem* vxSystem) {
...
void ExampleRunner::Events::MonitorEvents::PrintEventRow(IVxEvent* vxEvent) {
...
/// </summary>
void ExampleRunner::Events::MonitorEvents::PrintEventHeadings() {
    const int eventTimeWidth = 20;
    const int eventStringWidth = 32;
    cout << "\n--------------------------------------------------\n";
...
void ExampleRunner::Events::MonitorEvents::EventsCallBack(IVxEvent* vxEvent) {
...
bool ExampleRunner::Events::MonitorEvents::SubscribeEvents(IVxSystem* vxSystem) {
...
/// </summary>
/// <param name="vxSystem">system pointer</param>
bool ExampleRunner::Events::MonitorEvents::UnSubscribeEvents(IVxSystem* vxSystem) {
