...
Plugin* ExampleRunner::DataSource::ViewDataSourceDetails::Run(DataModel* dataModel) {
    cout << "\n\n";
...
VxCollection<IVxDataSource**> ExampleRunner::DataSource::ViewDataSourceDetails::GetDataSources(IVxSystem* vxSystem) {
...
void ExampleRunner::DataSource::ViewDataSourceDetails::PrintDataSourceCollection(VxCollection<IVxDataSource**> collection) {
...
void ExampleRunner::DataSource::ViewDataSourceDetails::ShowDataSourceDetails(IVxDataSource* dataSource) {
    // Read PTZ info
    bool canPtz;
