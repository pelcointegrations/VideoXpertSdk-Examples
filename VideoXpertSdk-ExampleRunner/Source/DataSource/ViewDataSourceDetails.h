...
namespace ExampleRunner {
    namespace DataSource {
        ...
        /// </summary>
        class ViewDataSourceDetails : public ExampleRunner::Common::Plugin {
        public:
            ViewDataSourceDetails(const std::string description) : ExampleRunner::Common::Plugin(description) { }
