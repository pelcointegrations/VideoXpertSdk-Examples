...
Plugin* ExampleRunner::DataSource::ViewAllDataSource::Run(DataModel* dataModel) {
    cout << "\n\n";
...
VxCollection<IVxDataSource**> ExampleRunner::DataSource::ViewAllDataSource::GetDataSources(IVxSystem* vxSystem) {
...
void ExampleRunner::DataSource::ViewAllDataSource::PrintDataSourceCollection(VxCollection<IVxDataSource**> collection) {
    Utility::ClearScreen();
...
void ExampleRunner::DataSource::ViewAllDataSource::PrintDataSource(int number, IVxDataSource* dataSource) {
