...
Plugin* ExampleRunner::DataSource::ViewDataSourceByPage::Run(DataModel* dataModel) {
    cout << "\n\n";
...
VxCollection<IVxDataSource**> ExampleRunner::DataSource::ViewDataSourceByPage::GetDataSources(IVxSystem* vxSystem) {
...
void ExampleRunner::DataSource::ViewDataSourceByPage::PrintDataSource(int number, IVxDataSource* dataSource) {
    cout << number << "\t" << dataSource->name << "\n";
}

// Print the given collection of data source to the screen.
void ExampleRunner::DataSource::ViewDataSourceByPage::PrintDataSourceCollection(VxCollection<IVxDataSource**> collection) {
