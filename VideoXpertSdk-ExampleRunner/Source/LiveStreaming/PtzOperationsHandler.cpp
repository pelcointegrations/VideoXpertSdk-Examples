...
bool ExampleRunner::LiveStreaming::PtzOperationsHandler::DoOperation(char keyCode) {
...
VxCollection<IVxPattern**> ExampleRunner::LiveStreaming::PtzOperationsHandler::GetPatterns() const {
...
VxCollection<IVxPreset**> ExampleRunner::LiveStreaming::PtzOperationsHandler::GetPresets() const {
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveDown() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveDownLeft() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveDownRight() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveLeft() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
// Move the camera up
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveUp() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveUpLeft() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveUpRight() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::MoveRight() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
void ExampleRunner::LiveStreaming::PtzOperationsHandler::TriggerPattern(){
    _showResult = false;
    // Verify the instance of PTZ controller.
    if (_ptzControl != nullptr) {
        cout << "\nFetching patterns...";
...
void ExampleRunner::LiveStreaming::PtzOperationsHandler::TriggerPreset(){
    _showResult = false;
    // Verify the instance of PTZ controller.
    if (_ptzControl != nullptr) {
        cout << "\nFetching presets...";
...
// Zoom in the camera
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::ZoomIn() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
...
// Zoom out the camera
VxResult::Value ExampleRunner::LiveStreaming::PtzOperationsHandler::ZoomOut() const {
    // Verify the instance of PTZ controller.
    if (_ptzControl == nullptr)
        return VxResult::kInvalidParameters;
