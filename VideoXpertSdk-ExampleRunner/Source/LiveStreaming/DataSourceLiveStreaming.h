...
namespace ExampleRunner {
    namespace LiveStreaming {
        ...
        /// </summary>
        class DataSourceLiveStreaming : public ExampleRunner::Common::Plugin {
        private:
            bool _isPlayBack;
        ...
        protected:
            ...
            static void DisplayPlayerOptionsToConsole(bool isPtzEnabled, bool isLive, bool isRecording, bool isPlaybackMode);
