...
Plugin* ExampleRunner::DataObjects::ViewAllDataObjects::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxDataObject**> ExampleRunner::DataObjects::ViewAllDataObjects::GetDataObjects(IVxSystem* vxSystem) {
...
void ExampleRunner::DataObjects::ViewAllDataObjects::PrintDataObjects(VxCollection<IVxDataObject**> dataObjectCollection) {
