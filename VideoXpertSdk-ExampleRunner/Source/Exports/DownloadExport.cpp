...
Plugin* ExampleRunner::Exports::DownloadExport::Run(DataModel* dataModel) {
...
void ExampleRunner::Exports::DownloadExport::DisplayExportDetailsOnScreen(VxCollection<IVxExport**> exportCollection) {
...
// Downloads an export from the current system and saves as a file.
bool ExampleRunner::Exports::DownloadExport::Download(IVxSystem* vxSystem) const {
...
/// </summary>
string ExampleRunner::Exports::DownloadExport::GetExportFormatInString(VxExportFormat::Value expFormat) {
...
VxCollection<IVxExport**> ExampleRunner::Exports::DownloadExport::GetExports(IVxSystem* vxSystem) {
...
/// </summary>
string ExampleRunner::Exports::DownloadExport::GetExportStatusInString(VxExportStatus::Value expStatus, bool shortStr) {
    string expStatusInString = "U";
...
int ExampleRunner::Exports::DownloadExport::ProgressFunc(void* ptr, double dltotal, double dlnow) {
...
void ExampleRunner::Exports::DownloadExport::ShowExportDetails(IVxExport* vxExport) {
    cout << "\n" << "  Export you selected: " << "\n";
    cout << "\n" << "-------------------------------------------------------------------";
    cout << "\n" << "  Name: " << vxExport->name;
...
size_t ExampleRunner::Exports::DownloadExport::WriteData(void *ptr, size_t size, size_t nmemb, FILE *stream) {
