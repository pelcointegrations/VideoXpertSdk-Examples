...
Plugin* ExampleRunner::Exports::DeleteExport::Run(DataModel* dataModel) {
...
// Deletes an export from the current system.
void ExampleRunner::Exports::DeleteExport::DeleteSingleExport(IVxSystem* vxSystem) {
...
void ExampleRunner::Exports::DeleteExport::DisplayExportDetailsOnScreen(VxCollection<IVxExport**> exportCollection) {
...
VxCollection<IVxExport**> ExampleRunner::Exports::DeleteExport::GetExports(IVxSystem* vxSystem) {
