...
Plugin* ExampleRunner::Exports::CreateExport::Run(DataModel* dataModel) {
    cout << "\n\n";
...
void ExampleRunner::Exports::CreateExport::CreateNewExportOption(VxCollection<IVxDataSource**> dataSources, IVxSystem* vxSystem) const {
...
VxCollection<IVxClip**> ExampleRunner::Exports::CreateExport::GetClips(IVxDataSource* dataSource) {
...
VxCollection<IVxDataSource**> ExampleRunner::Exports::CreateExport::GetDataSources(IVxSystem* vxSystem) {
...
IVxExport* ExampleRunner::Exports::CreateExport::GetExport(IVxSystem* vxSystem, const char* expName, const char* id) const {
