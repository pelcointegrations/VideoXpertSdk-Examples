...
Plugin* ExampleRunner::Exports::ViewExport::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
void ExampleRunner::Exports::ViewExport::DisplayExportDetailsOnScreen(VxCollection<IVxExport**> exportCollection) {
...
VxCollection<IVxExport**> ExampleRunner::Exports::ViewExport::GetExports(IVxSystem* vxSystem) {
