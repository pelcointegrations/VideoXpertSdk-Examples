...
namespace ExampleRunner {
    namespace Common {
        ...
        /// </summary>
        class MenuItem : public ExampleRunner::Common::Plugin {
        public:
            MenuItem(const std::string description) : ExampleRunner::Common::Plugin(description) { }
            ~MenuItem() { }
        ...
        /// </summary>
        class BackMenu : public ExampleRunner::Common::Plugin {
        public:
        ...
        /// </summary>
        class ExitMenu : public ExampleRunner::Common::Plugin {
        public:
