...
Plugin* ExampleRunner::Bookmarks::AddBookmark::Run(DataModel* dataModel) {
...
void ExampleRunner::Bookmarks::AddBookmark::AddNew(IVxSystem* vxSystem) {
    // Data Source ID
...
VxCollection<IVxDataSource**> ExampleRunner::Bookmarks::AddBookmark::GetDataSources(IVxSystem* vxSystem) {
...
int ExampleRunner::Bookmarks::AddBookmark::SelectDataSourceIndex(VxCollection<IVxDataSource**> &dataSources) {
    while (true) {
