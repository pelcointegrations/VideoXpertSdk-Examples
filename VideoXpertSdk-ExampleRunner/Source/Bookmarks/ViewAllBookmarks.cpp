...
Plugin* ExampleRunner::Bookmarks::ViewAllBookmarks::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxBookmark**> ExampleRunner::Bookmarks::ViewAllBookmarks::GetBookmarks(IVxSystem* vxSystem) {
...
void ExampleRunner::Bookmarks::ViewAllBookmarks::PrintBookmarks(VxCollection<IVxBookmark**> bookmarkCollection) {
