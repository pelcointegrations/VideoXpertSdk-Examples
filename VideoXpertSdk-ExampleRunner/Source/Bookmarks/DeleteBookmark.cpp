...
Plugin* ExampleRunner::Bookmarks::DeleteBookmark::Run(DataModel* dataModel) {
    system("cls");
...
VxCollection<IVxBookmark**> ExampleRunner::Bookmarks::DeleteBookmark::GetBookmarks(IVxSystem* vxSystem) {
...
void ExampleRunner::Bookmarks::DeleteBookmark::PrintBookmarks(VxCollection<IVxBookmark**> bookmarkCollection) {
...
int ExampleRunner::Bookmarks::DeleteBookmark::SelectBookmarkIndex(VxCollection<IVxBookmark**> &bookmarks) {
    while (true) {
