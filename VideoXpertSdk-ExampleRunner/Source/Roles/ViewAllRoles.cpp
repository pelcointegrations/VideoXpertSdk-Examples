...
Plugin* ExampleRunner::Roles::ViewAllRoles::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxRole**> ExampleRunner::Roles::ViewAllRoles::GetRoles(IVxSystem* vxSystem) {
...
void ExampleRunner::Roles::ViewAllRoles::PrintRoles(VxCollection<IVxRole**> roleCollection) {
