...
Plugin* ExampleRunner::Roles::DeleteRole::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxRole**> ExampleRunner::Roles::DeleteRole::GetRoles(IVxSystem* vxSystem) {
...
void ExampleRunner::Roles::DeleteRole::PrintRoles(VxCollection<IVxRole**> roleCollection) {
...
int ExampleRunner::Roles::DeleteRole::SelectRoleIndex(VxCollection<IVxRole**> &roles) {
    while (true) {
