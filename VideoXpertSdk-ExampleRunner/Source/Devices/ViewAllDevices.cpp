...
Plugin* ExampleRunner::Devices::ViewAllDevices::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxDevice**> ExampleRunner::Devices::ViewAllDevices::GetDevices(IVxSystem* vxSystem) {
...
void ExampleRunner::Devices::ViewAllDevices::PrintDevices(VxCollection<IVxDevice**> deviceCollection) {
