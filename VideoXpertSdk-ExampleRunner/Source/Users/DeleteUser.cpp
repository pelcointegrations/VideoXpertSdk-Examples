...
Plugin* ExampleRunner::Users::DeleteUser::Run(DataModel* dataModel) {
    Utility::ClearScreen();
...
VxCollection<IVxUser**> ExampleRunner::Users::DeleteUser::GetUsers(IVxSystem* vxSystem) {
...
void ExampleRunner::Users::DeleteUser::PrintUsers(VxCollection<IVxUser**> userCollection) {
...
int ExampleRunner::Users::DeleteUser::SelectUserIndex(VxCollection<IVxUser**> &users) {
    while (true) {
